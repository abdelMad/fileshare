            ...
            <ul id="inbox-tabs" class="inbox-tabs nav nav-tabs padding-16 tab-size-bigger tab-space-1">
                <li class="li-new-mail pull-right">
                    <a data-toggle="tab" href="#write" data-target="write" class="btn-new-mail">
														<span class="btn btn-purple no-border">
															...
															<span class="bigger-110">Nouveau Email</span>
														</span>
                    </a>
                </li><!-- /.li-new-mail -->
                ...
                <li>
                    <a data-toggle="tab" href="#sent" data-target="sent">
                        ...
                        <span class="bigger-110">Envoyé</span>
                    </a>
                </li>
            </ul>
                    ...
                    <div class="message-container">
                        <div id="id-message-list-navbar" class="message-navbar clearfix">
                            <div class="message-bar">
                                <div class="message-infobar" id="id-message-infobar">
                                    <span class="blue bigger-150">Boîte de réception</span>
                                    <span class="grey bigger-110">(2 messages non lu)</span>
                                </div>
                                ...
                                <div class="message-toolbar hide">
                                    ...
                                    <button type="button" class="btn btn-xs btn-white btn-primary">
                                        ...
                                        <span class="bigger-110">Supprimer</span>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="message-footer clearfix">
                            ...
                            <div class="pull-right">
                                <div class="inline middle"> page 1 de 16 </div>
...
<form id="id-message-form" class="hide form-horizontal message-form col-xs-12">
    <div>
        <div class="form-group">
            ...
            <div class="col-sm-9">
												<span class="input-icon">
													<input type="email" name="destinataire" id="form-field-recipient"  placeholder="alex@doe.com" />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6 col-xs-12">
                <div class="input-icon block col-xs-12 no-padding">
                    <input maxlength="100" type="text" class="col-xs-12" name="sujet" id="form-field-subject" placeholder="Sujet" />
